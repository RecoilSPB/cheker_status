...
import ru.spb.reshenie.chekerstatus.domain.nsi.DictionaryField;
...
@Service
public class NsiPersistenceService implements NsiPersistencePort {

    private final JdbcTemplate jdbcTemplate;
    private final ObjectMapper objectMapper;

    public NsiPersistenceService(JdbcTemplate jdbcTemplate, ObjectMapper objectMapper) {
