...
class GitCommitTrackingServiceTest {
    ...
    void progressIncludesCheckedGitLinksEvenWhenNoNewChangesWereFound() {
        ...
        GitTrackingRepositoryPort repository = mock(GitTrackingRepositoryPort.class);
        GitLabVirtualThreadSyncExecutor executor = mock(GitLabVirtualThreadSyncExecutor.class);
        NsiSyncRunService syncRunService = mock(NsiSyncRunService.class);
